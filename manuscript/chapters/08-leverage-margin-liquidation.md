...
=\frac{|Q|\times p\_{\mathrm{entry}}}{L}
\\]
...
\\[
\begin{aligned}
0&\le N<50{,}000\ \mathrm{USDT} \\\\
\mathrm{MMR}&=0.004 \\\\
A&=0\ \mathrm{USDT} \\\\
L\_{\mathrm{initial,max}}&=125
\end{aligned}
\\]
...
\begin{aligned}
N&=|0.5|\times20{,}000
  =10{,}000.00\ \mathrm{USDT} \\\\
\mathrm{MM}&=10{,}000\times0.004-0
  =40.00\ \mathrm{USDT}
\end{aligned}
\\]
...
\mathrm{MB}\_{\mathrm{cross}}
  &=W\_{\mathrm{cross}}+\sum\_i U\_{\mathrm{cross},i} \\\\
\mathrm{MR}
  &=\frac{\sum\_i\mathrm{MM}\_i}{\mathrm{MB}},
    \qquad \mathrm{MB}>0
\end{aligned}
\\]
...
\\[
\begin{aligned}
N&=10{,}000.00\ \mathrm{USDT} \\\\
U&=0.00\ \mathrm{USDT} \\\\
\mathrm{IM}\_{\mathrm{position}}&=2{,}000.00\ \mathrm{USDT} \\\\
\mathrm{MM}&=40.00\ \mathrm{USDT} \\\\
\mathrm{MB}&=2{,}000.00\ \mathrm{USDT} \\\\
\mathrm{MR}&=\frac{40}{2{,}000}=2.0000\%
\end{aligned}
\\]
...
\begin{aligned}
p\_{\mathrm{liq,long}}
  &=\frac{2{,}000-0+0+0-0.5\times20{,}000}
          {0.5\times0.004-0.5} \\\\
  &=16{,}064.257028\ldots\
    \frac{\mathrm{USDT}}{\mathrm{BTC}} \\\\
p\_{\mathrm{liq,long,display}}
  &=16{,}064.26\ \frac{\mathrm{USDT}}{\mathrm{BTC}} \\\\
\mathrm{buffer}\_{\mathrm{long}}
  &=19.678715\%
\end{aligned}
\\]
...
\begin{aligned}
\mathrm{MB}
  &=2{,}000+(16{,}064.257028\ldots-20{,}000)\times0.5 \\\\
  &=32.128514056225\ \mathrm{USDT} \\\\
\mathrm{MM}
  &=0.5\times16{,}064.257028\ldots\times0.004 \\\\
  &=32.128514056225\ \mathrm{USDT}
\end{aligned}
\\]
...
\\[
\begin{aligned}
p\_{\mathrm{liq,short}}
  &=\frac{2{,}000-0+0+0-(-0.5)\times20{,}000}
          {0.5\times0.004-(-0.5)} \\\\
  &=23{,}904.382470\ldots\
    \frac{\mathrm{USDT}}{\mathrm{BTC}} \\\\
p\_{\mathrm{liq,short,display}}
  &=23{,}904.38\ \frac{\mathrm{USDT}}{\mathrm{BTC}} \\\\
\mathrm{buffer}\_{\mathrm{short}}
  &=19.521912\%
\end{aligned}
\\]
...
\\[
\begin{aligned}
\mathrm{MB}(p\_{\mathrm{liq}})&=\mathrm{MM}(p\_{\mathrm{liq}}) \\\\
p\_{\mathrm{liq,long}}&<p\_{\mathrm{entry}}<p\_{\mathrm{liq,short}}
\end{aligned}
\\]
...
\begin{aligned}
\text{Cross：}\quad
\mathrm{TMM}\_{\mathrm{other}},\,U\_{\mathrm{other}}
  &\text{納入組合公式} \\\\
\text{Isolated：}\quad
\mathrm{TMM}\_{\mathrm{other}}=U\_{\mathrm{other}}&=0
\end{aligned}
\\]
...
\\[
\begin{aligned}
Q,p\_{\mathrm{entry}},m\ \text{不變}
  &\Rightarrow N,U\ \text{不變} \\\\
L\ \text{改變}
  &\Rightarrow \mathrm{IM}\_{\mathrm{position}}\ \text{target 改變} \\\\
M\_{\mathrm{isolated}}\ \text{不變}
  &\Rightarrow p\_{\mathrm{liq}}\ \text{不變}
\end{aligned}
\\]
...
\\[
\begin{aligned}
\mathrm{MM}&=35.20\ \mathrm{USDT} \\\\
\mathrm{MB}&=-200.00\ \mathrm{USDT} \\\\
\mathrm{MR}&=\text{未定義}
\end{aligned}
\\]
