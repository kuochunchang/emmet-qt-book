...
```text
多頭 Q > 0：CF_funding < 0，帳戶支付
空頭 Q < 0：CF_funding > 0，帳戶收取
零倉 Q = 0：CF_funding = 0
```
...
```text
W_after = W_before + CF_funding
E_futures = W_after + U
          = W_before + CF_funding + U
```
...
```text
p_entry = 20,000.00 USDT/BTC
m_f     = 20,400.00 USDT/BTC
r_f     = +0.0005
W_before = 2,000.00 USDT

SpotWallet before = 5,000.00 USDT + 0.25000000 BTC
```
...
W_after,long = 2,000.00 - 5.10
             = 1,994.90 USDT

E_futures,long = 1,994.90 + 200.00
               = 2,194.90 USDT
```
...
W_after,short = 2,000.00 + 5.10
              = 2,005.10 USDT

E_futures,short = 2,005.10 - 200.00
                = 1,805.10 USDT
```
...
N_flat = 0 USDT
U_flat = 0 USDT
CF_flat = -(0) × 20,400 × 0.0005 = 0 USDT
W_after,flat = 2,000.00 USDT
E_futures,flat = 2,000.00 USDT
```
...
```text
SpotWallet_after = SpotWallet_before
FuturesWallet_after = FuturesWallet_before + CF_funding
```
...
```text
E_futures = W_before + CF_funding + U
          = W_after + U
```
