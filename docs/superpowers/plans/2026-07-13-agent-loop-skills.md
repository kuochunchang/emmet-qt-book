...
```bash
grep -oh "loop:[a-z][a-z-]*" docs/agent-loop.md | sort -u
scripts/book-check
```
...
grep -oh "loop:[a-z][a-z-]*" .claude/skills/dispatcher/SKILL.md | sort -u
```
...
grep -oh "loop:[a-z][a-z-]*" .claude/skills/coder/SKILL.md | sort -u
```
...
grep -roh "loop:[a-z][a-z-]*" .claude/skills docs/agent-loop.md | sort -u
```
